...
' | sha512sum| $PrPWD/stdcarsin ' '
			    ...
			    echo "$aspectosasc"| ../stdcdr "char ascencional_planets"|../stdcar ";" >> "$PaPWD/$tooutputc.c"
			    ...
			    echo "$aspectosasc"| ../stdcdr "double planetas_ascencional"|../stdcar ";" >> "$PaPWD/$tooutputc-ii.c"
			    ...
			    echo "$ASC"| ../stdcdr "double planetas_ascencional"|../stdcar ";" >> "$PaPWD/$tooutputc.c"
			    cat $PaPWD/$tooutputc-ii.c | $PrPWD/stdcdr "double ASC" | $PrPWD/stdcdr ";" >> "$PaPWD/$tooutputc.c"

			    cat $PaPWD/$tooutputc.c | $PrPWD/stdcar "double ascencional_planets" > "$PaPWD/$tooutputc-ii.c"
			    echo "$aspectosasc"| ../stdcdr "double ascencional_planets"|../stdcar ";" >> "$PaPWD/$tooutputc-ii.c"
			    cat $PaPWD/$tooutputc-ii.c | $PrPWD/stdcdr "double ascencional_planets" | $PrPWD/stdcdr ";" >> "$PaPWD/$tooutputc-ii.c"
			fi
		    fi
		fi
	    fi
